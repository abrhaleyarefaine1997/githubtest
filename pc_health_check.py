...
MEMORY_THRESHOLD = 1000  # megabytes of available memory
NETWORK_HOST = "www.google.com"  # host to ping for network connectivity

# Define the email details /sender and reciever 
SENDER_EMAIL = "abrhaleyarefaine1997@gmail.com"  # email address of the sender
RECEIVER_EMAIL = "aabrehaley@gmail.com"  # email address of the receiver
